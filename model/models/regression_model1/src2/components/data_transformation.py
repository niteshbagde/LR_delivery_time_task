...
from model.models.regression_model1.M2utils import save_obj , data_pathfor_csv

@dataclass
class DataTransformationConfig:
    pickel_data_path = os.getcwd()+"\\"+project_name
    preprocessor_obj_file_path = pickel_data_path+"\\model\\artifacts\\"+"M2processor.pkl"
