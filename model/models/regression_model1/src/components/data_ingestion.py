...
from model.models.regression_model1.utils import data_pathfor_csv
...
class DataIngestionConfig():
    ...
    train_data_path = os.path.join(path__+"/data/interim", "train.csv")
    test_data_path = os.path.join(path__+"/data/interim", "test.csv")
    raw_data_path = os.path.join(path__+"/data/interim", "raw_copy.csv")
